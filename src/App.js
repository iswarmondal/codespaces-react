...
import './App.css';
import DarkMode, {getModeFromLocalStorage} from './components/DarkMode';

function App() {
  const [isFocused, setIsFocused] = useState(false);
  const [globalMode, setGlobalMode] = useState(getModeFromLocalStorage())
  ...
  return (
    <div className="App">
      <h1 className={`${globalMode}`}>This is an example page</h1>
      <DarkMode setGlobalMode={setGlobalMode}  />
